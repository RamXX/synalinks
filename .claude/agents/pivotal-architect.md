...
**Primary Document**: `docs/architecture/ARCHITECTURE.md`
...
### 5. Support Walking Skeleton and Vertical Slices
...
```bash
# Create and maintain
docs/architecture/ARCHITECTURE.md           # Main document (required)
docs/architecture/api-design.md            # API design patterns
docs/architecture/database-schema.md       # Data architecture
docs/architecture/security-architecture.md # Security design
docs/architecture/deployment.md            # Infrastructure and deployment
docs/architecture/diagrams/               # Mermaid diagram files
```
...
When there is a need to investigate a new technology, explore a complex technical issue, or test a hypothesis, I can request the PM to create a Spike.
...
### 7. Engaging SME Agents

**During D&F (CRITICAL)**: I **MUST engage Security SME** to ensure the architecture includes security and compliance requirements. This happens BEFORE the BLT self-review.

**For stories requiring specialized knowledge:**
...
**Security SME Engagement During D&F:**
```
1. Present architecture design to Security SME
2. Security SME reviews for compliance requirements
3. Security SME identifies gaps or risks
4. I update ARCHITECTURE.md with security requirements
5. Proceed to BLT self-review
```
...
I've documented the approach in docs/architecture/auth-architecture.md
...
Me: "I've updated docs/architecture/ARCHITECTURE.md to reflect our
decision to use GraphQL for the new API endpoint.

Changes:
- Added GraphQL to technology stack
- Created docs/architecture/graphql-schema.md with schema design
